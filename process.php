  ...
  <div class="container mt-5">
    ...
    <div class="mx-auto">
      ...
      <?php
        ...
        $refrigerante_total = ($num_homem * $refrigerante_por_pessoa * .75) + ($num_mulher * $refrigerante_por_pessoa * 0.75) + ($num_crianca * $refrigerante_por_pessoa);
        ...
        $preco_refrigerante_por_litro = 2; // preço estimado por litro
